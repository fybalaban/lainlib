/*
 *         lainlib.Cryptography.AESManaged
 * 
...
{
    /// <summary>
    /// Provides methods for file, string and byte array encryption/decryption with AES. Uses System.Security.Cryptography.AesManaged. Managed code is faster and safer with small loads.
    /// </summary>
    public class AESManaged
    {
        ...
        /// <summary>
        /// Initializes AESManaged with default parameters (PKCS #7, CBC, AES-256)
        /// </summary>
        public AESManaged()
        {
        ...
        /// </summary>
        /// <param name="cipher">Byte[] to decrypt</param>
        /// <returns></returns>
